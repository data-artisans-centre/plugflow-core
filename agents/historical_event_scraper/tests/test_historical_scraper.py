...
@pytest.fixture
def historical_event_scraper(monkeypatch):
    ...
    monkeypatch.setattr("agents.historical_event_scraper.requests.get", MockRequests.get)
    return agent
...
def test_execute_no_events(historical_event_scraper, monkeypatch):
...
def test_execute_invalid_url(historical_event_scraper, monkeypatch):
...
def test_health_check_success(historical_event_scraper):
    ...
    health = historical_event_scraper.health_check()
...
def test_health_check_failure(monkeypatch):
    ...
    monkeypatch.setattr("agents.historical_event_scraper.requests.get", mock_service_failure)
    agent = HistoricalEventsAgent()
